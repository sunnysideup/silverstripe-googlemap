jQuery(document).ready(function(){if("undefined"!==typeof GoogleMapConstructors)for(var h=0;h<GoogleMapConstructors.length;h++){var l=GoogleMapConstructors[h];GoogleMapConstructors[h].googleMap=new GoogleMapConstructor(l.divID,null,"GoogleMapConstructors["+h+"].googleMap.getMap()",l.options);GoogleMapConstructors[h].googleMap.init();if("undefined"!==typeof l.layers){var q=l.layers;if(0<q.length)for(var m=0;m<q.length;m++)GoogleMapConstructors[h].googleMap.addLayer(q[m].link,q[m].title)}"undefined"!==
typeof l.address&&0<l.address.length&&GoogleMapConstructors[h].googleMap.findAddress(l.address);0===h&&0<jQuery("#SearchByAddressForm_SearchByAddressForm").length&&(GMO=GoogleMapConstructors[h].googleMap,jQuery("#SearchByAddressForm_SearchByAddressForm").ajaxForm({error:function(){alert("Could not find address!")},success:function(a,b,c,d){b=jQuery("base").attr("href")+"/googlemap/";b+=""+a.Action+"/";b+=""+a.ParentID+"/";b+=""+a.Title+"/";b+=""+a.Lng+"/";b+=""+a.Lat+"/";b+=""+a.ClassNames+"/";console.debug(b);
GoogleMapConstructors[0].googleMap.addLayer(b,a.Title)},dataType:"json"}))}});
...
b&&(e++,1===c?(this.gmarkers[f].setVisible(!0),d="shown"):("undefined"!==typeof this.gmarkers[f].infowindow&&this.gmarkers[f].infowindow.close(),this.gmarkers[f].setVisible(!1),d="hidden"));this.layerInfo[b].show=c;this.updateLists();this.updateStatus(a._t.points+" ("+e+") "+d+".")},createMarker:function(b,c,d,e,f){var g=this.layerInfo.length-1,n=this.opts.markerOptions||{};f||(f="http://maps.google.com/mapfiles/marker_yellow"+c[0].toUpperCase()+".png");f=this.createStandardIcon(f);n.icon=f;n.title&&
(n.title=c);n.position=b;n.map=a.mapObject;var k=new google.maps.Marker(n);k.layerId=g;k.markerName=c;k.markerDesc=d.nodeValue;k.type="marker";k.serverId=e;this.opts.updateServerUrlDragend?(n.draggable=!0,k.draggable=!0,google.maps.event.addListener(k,"dragend",function(){a.updateStatus("<p>"+a._t.updating_database+"</p>");var b=k.getPoint().lng(),c=k.getPoint().lat();jQuery.get(a.opts.updateServerUrlDragend,{x:b,y:c,i:k.serverId,a:"move"},function(b){a.updateStatus("<p>"+b+"</p>")})})):(n.draggable=
!1,k.draggable=!1);b=a.retrieveInfoWindowContent(k);c=this.opts.infoWindowOptions||{};c.content=b;var h=new google.maps.InfoWindow(c);google.maps.event.addListener(k,"click",function(){h.open(a.mapObject,k);a.lastMarker=k;a.lastInfoWindow=h});google.maps.event.addListener(k,"rightclick",function(){k.setMap(null);a.updateLists();if(a.opts.updateServerUrlDragend){var b=k.getPoint().lng(),c=k.getPoint().lat();jQuery.get(a.opts.updateServerUrlDragend,{x:b,y:c,i:k.serverId,a:"remove"},function(b){a.updateStatus("<p>"+
b+"</p>")})}});k.setMap(a.mapObject);this.gmarkers.push(k);this.gmarkers.push(k);return k},retrieveInfoWindowContent:function(b){var c=a.checkForHiddenMarkers(b),d=b.markerName,e=b.markerDesc,f=b.getPosition(),g=[],n="";1<this.layerInfo[b.layerId].pointCount&&google.maps.event.addListener(b,"hideGroup",function(){a.changeLayerVisibility(b.layerId);infowindow.close()});this.opts.addAntipodean&&(g.push('<a href="#" onclick="google.maps.event.trigger('+a.variableName+".getMap().lastMarker,'clickAntipodean'); return false;\">"+
a._t.drill_a_hole+"</a>"),google.maps.event.addListener(b,"clickAntipodean",function(){a.mapObject.setZoom(6);var c=b.getPosition(),c=a.antipodeanPointer(c.lng(),c.lat()),d=a.checkLongitude(f.lng()),e=a.checkLatitude(f.lat()),c=a.createPointXml(a._t.antipodean_of+" "+b.markerName,c,a._t.found_opposite,d,e,3);a.processXml(c)}));b.draggable&&g.push("<b>"+a._t.drag_instructions+"</b>");if(c.length){for(var n=n+(' <p><span class="partialObscuring">'+a._t.partial_obscuring),k=0;k<c.length;k++){var h=c[k],
n=n+(' <a href="#" onclick="'+a.variableName+".showMarkerFromList("+h+'); return false;">'+this.gmarkers[h].markerName+"</a>");k<c.length-2?n+=", ":k==c.length-2&&(n+=a._t.and_with_spaces)}n+="</span></p>"}c='<div id="infoWindowTab1" class="infoWindowTab"><h1>'+d+"</h1>"+n+"<div>"+e+"</div>";this.opts.addZoomInButton&&g.push('<a href="#" onclick="google.maps.event.trigger('+a.variableName+".lastMarker,'clickZoomIn'); return false;\">zoom in</a>");this.opts.addDeleteMarkerButton&&g.push('<a href="#" onclick="google.maps.event.trigger('+
a.variableName+".lastMarker,'clickRemoveMe'); return false;\">"+this.opts.addDeleteMarkerButton+"</a>");g.length&&(c+='<p class="infoTabExtraLinks">'+g.join(", ")+".</p>");google.maps.event.addListener(b,"clickZoomIn",function(){(new google.maps.MaxZoomService).getMaxZoomAtLatLng(b.position,function(c){c.status!=google.maps.MaxZoomStatus.OK?alert(a._t.error_in_zoom):(a.mapObject.setZoom(c.zoom),a.mapObject.setCenter(b.position))})});google.maps.event.addListener(b,"clickRemoveMe",function(){b.setMap(null)});
this.opts.addDirections&&(g="",this.opts.addDirections&&(this.currentFromLocation(),g='<p class="infoTabFromOption"> <b>'+a._t.from+':</b></p><p id="fromHereLink"> <a href="#" onclick="google.maps.event.trigger('+a.variableName+".lastMarker,'clickFromHere')\">"+a._t.select_this_point+"</a>:  "+this.currentFromLocation()+'</p><p class="infoTabToOption"> <b>'+a._t.to+':</b></p><p id="toHereLink"> <a href="#" onclick="google.maps.event.trigger('+a.variableName+".lastMarker,'clickToHere'); return false;\">"+
a._t.select_this_point+"</a>: "+this.currentToLocation()+'</p><p class="infoTabAlternative">',this.routeShown?g+=" <b>"+a._t.do_next+':</b></p><p> <a href="#" onclick="return google.maps.event.trigger('+a.variableName+'.lastMarker,\'clickClearRoute\'); return false;" id="clearRouteLink">'+a._t.clear_last_route+"</a> ":this.floatFrom||this.floatTo||this.to||this.from?g+="<b>"+a._t.do_next+':</b></p><p><a href="#" class="submitButton" onclick="google.maps.event.trigger('+a.variableName+'.lastMarker,\'clickFindRoute\'); return false;" id="calculateLinkRoute">'+
a._t.calculate_route+"</a>":1<this.layerInfo[b.layerId].pointCount&&20>this.layerInfo[b.layerId].pointCount&&(g+='<span class="alternatively">'+a._t.alernatively+'</p><p><a href="#" class="submitButton" onclick="google.maps.event.trigger('+a.variableName+'.lastMarker,\'joinTheDots\')" id="calculateLinkRoute">'+a._t.create_routes_using_current_points+"</a>"),g+="</p>",google.maps.event.addListener(b,"joinTheDots",function(){a.createRouteFromLayer(b.layerId)}),google.maps.event.addListener(b,"clickFromHere",
...
(f=c.y);g||(g=5);b='<?xml version="1.0" encoding="UTF-8"?><kml xmlns="http://earth.google.com/kml/2.1"><Document><mapinfo><title>'+b+"</title><longitude>"+e+"</longitude><latitude>"+f+"</latitude><zoom>"+g+"</zoom><pointcount>1</pointcount><info>"+n+"</info></mapinfo><Placemark> <id>"+("Marker_manuallyAdded"+a.layerInfo.length)+"</id> <name>"+b+"</name> <Point><coordinates>"+c.lng()+","+c.lat()+"</coordinates></Point> <description><![CDATA[ <p>"+d+"</p>]]\x3e</description></Placemark></Document></kml>";
...
this.latestUrl=b,downloadUrl(b,function(b){a.processXml(b)}))},processXml:function(b){this.bounds=new google.maps.LatLngBounds;if(0<b.getElementsByTagName("pointcount").length){var c=b.getElementsByTagName("pointcount")[0].childNodes[0].nodeValue,c=parseInt(c);this.tooManyPointsWarning(c+1);var d=null;if(0<c){var d=this.layerInfo.length,e={},f=[];e.show=1;e.url=this.latestUrl;this.latestUrl="";e.pointCount=c;var g=b.getElementsByTagName("mapinfo")[0],n=b.getElementsByTagName("Placemark");e.title=
g.getElementsByTagName("title")[0].firstChild.nodeValue;null!==g.getElementsByTagName("info")[0].firstChild&&(e.info=g.getElementsByTagName("info")[0].firstChild.nodeValue);e.a=g.getElementsByTagName("latitude")[0].firstChild.nodeValue;e.o=g.getElementsByTagName("longitude")[0].firstChild.nodeValue;e.z=g.getElementsByTagName("zoom")[0].firstChild.nodeValue;var k=d+1,d=0;k>this.opts.iconMaxCount&&(k=1);g="";k&&(this.opts.iconFolder||this.opts.defaultIconUrl)&&(g=this.opts.defaultIconUrl||this.opts.iconFolder+
"i"+k+"."+this.opts.iconExtension);this.layerInfo.push(e);for(var k=[],e=k=null,h=0;h<n.length;h++){var l=n[h].getElementsByTagName("id")[0].childNodes[0],m=n[h].getElementsByTagName("name")[0].childNodes[0].nodeValue,q=n[h].getElementsByTagName("description")[0].childNodes[0],p=null;0<n[h].getElementsByTagName("styleUrl").length&&(p=n[h].getElementsByTagName("styleUrl")[0],p=p.substring(1,p.length));var u="";""!==g&&(u=g);if(p)for(var t=b.getElementsByTagName("Style"),r=0;r<t.length;r++)t[r].getAttribute("id")&&
t[r].getAttribute("id")==p&&(d++,u=t[r].getElementsByTagName("Icon")[0].childNodes[0]);p=n[h].getElementsByTagName("coordinates")[0].childNodes[0].nodeValue;p=p.replace(/\s+/g," ");p=p.replace(/^ /,"");p=p.replace(/, /,",");r=p.split(" ");if(1<r.length){l=[];p=new google.maps.LatLngBounds;for(t=0;t<r.length-1;t++)k=r[t].split(","),k=new google.maps.LatLng(parseFloat(k[1]),parseFloat(k[0])),l.push(k),this.bounds.extend(k),p.extend(k);this.opts.polyIcon&&(u=this.opts.polyIcon);var r=this.opts.lineWidth,
v=this.opts.lineColour,w=this.opts.lineOpacity,t=n[h].getElementsByTagName("LineString"),x=n[h].getElementsByTagName("Polygon");t.length?t=this.createPolyline(l,v,r,w,m,q):x.length?t=this.createPolygon(l,v,r,w,this.opts.fillColour,this.opts.fillOpacity,p,m,q):alert(a._t.error_in_loading)}else k=r[0].split(","),k=new google.maps.LatLng(parseFloat(k[1]),parseFloat(k[0])),this.bounds.extend(k),this.updateStatus(a._t.processing+" "+h+" "+a._t.of+" "+c+"."),e=this.createMarker(k,m,q,l,u);f.inArray(u)||
f.push(u)}d=this.layerInfo.length-1;this.layerInfo[d].iconUrl=f;1<c?a.mapObject.fitBounds(this.bounds):a.mapObject.panTo(k);this.updateLists();e.getVisible||"undefined"!==typeof e.infowindow&&e.infowindow.close();1<c?this.updateStatus(c+" "+a._t.locations_added+"."):(window.setTimeout(function(){google.maps.event.trigger(a.gmarkers[a.gmarkers.length-1],"click");a.mapObject.panBy(0,1)},300),this.updateStatus(a._t.one_location_loaded))}else b=doc.getElementsByTagName("title")[0],this.opts.titleId&&
(el=document.getElementById(this.opts.titleId),el.innerHTML=b),this.opts.changePageTitle&&document.title&&(document.title=b)}},tooManyPointsWarning:function(b){100<b?this.updateStatus(b+" "+a._t.large_number_of_items):0===b&&this.updateStatus(a._t.no_location_could_be_found)},updateLists:function(){this.updateStatus(a._t.updating_lists);var b=[];if(this.opts.sideBarId||this.opts.dropBoxId||this.opts.layerListId){for(var c=[],d=0;d<this.layerInfo.length;d++)this.layerInfo[d].show=0;for(d=0;d<this.gmarkers.length;d++)this.gmarkers[d].getVisible()&&
(this.layerInfo[this.gmarkers[d].layerId].show=1,c.inArray(this.gmarkers[d].markerName)||b.push(this.gmarkers[d].markerName+"$$$"+d),c.push(this.gmarkers[d].markerName))}c=1<this.gmarkers.length?"block":"none";d=1<this.layerInfo.length?"block":"none";this.opts.sideBarId&&(jQuery("#"+this.opts.sideBarId).css("display",c),this.createSideBar(b));this.opts.dropBoxId&&(jQuery("#"+this.opts.dropBoxId).css("display",c),this.createDropDown(b));this.opts.titleId&&this.updateTitles();this.opts.layerListId&&
(jQuery("#"+this.opts.layerListId).css("display",d),this.updateLayerList());this.updateStatus(a._t.map_ready)},createSideBar:function(b){if(this.opts.sideBarId){var c="",c="",d=document.getElementById(this.opts.sideBarId);if(null!==d){if(1<b.length){for(var e='<ul id="'+this.opts.sideBarId+'list">',f=0;f<b.length;f++)var c=b[f].split("$$$",2),g=c[1],c=this.gmarkers[g].layerId,e=-1==String(this.gmarkers[g].serverId).indexOf("manuallyAdded",0)?e+('<li class="forLayer'+c+" icon"+g+'"> <a href="'+this.currentPageURL+
'#GoogleMapDiv" onclick="'+a.variableName+".showMarkerFromList("+g+'); return false;">'+this.gmarkers[g].markerName+'</a> <div class="infowindowDetails">'+this.gmarkers[g].markerDesc+"</div></li>"):e+('<li class="forLayer'+c+'">'+a._t.you_added+': <a href="'+this.currentPageURL+'#GoogleMapDiv" onclick="'+a.variableName+".showMarkerFromList("+g+'); return false;">'+this.gmarkers[g].markerName+"</a></li>");d.innerHTML=e+"</ul>";"undefined"!==typeof AdjustHeightsForGoogleMap&&(AdjustHeightsForGoogleMap.boxesSelector=
"#"+this.opts.sideBarId+"list > li",jQuery(window).resize(function(){AdjustHeightsForGoogleMap.adjustBoxes()()}),AdjustHeightsForGoogleMap.adjustBoxes()())}}else console.debug("you defined the dropbox like this "+this.opts.sideBarId+", but it does not exist")}},createDropDown:function(b){if(this.opts.dropBoxId&&1<b.length){var c=document.getElementById(this.opts.dropBoxId);if(null!==c){for(var d='<select onchange="GMO.showMarkerFromList(this.value);"><option selected="selected">'+a._t.select_a_location+
" </option>",e=0;e<b.length;e++)i=b[e].split("$$$",2)[1],d+='<option value="'+i+'">'+this.gmarkers[i].markerName+"</option>";c.innerHTML=d+"</select>"}else console.debug("you defined the dropbox like this "+this.opts.dropBoxId+", but it does not exist")}},updateLayerList:function(){if(this.opts.layerListId){var b=document.getElementById(this.opts.layerListId);if(null!==b){for(var c="<ul>",d,e,f,g=0;g<this.layerInfo.length;g++){1==this.layerInfo[g].show?(f="hide",d="layerListShown",e=""):(f="show",
d="layerListHidden",e=this.opts.hiddenLayersRemovedFromList?' style="display: none;"':' style="opacity:.30; filter: alpha(opacity=30); -moz-opacity: 0.30;"');c+='<li class="'+d+'"'+e+">";for(d=0;d<this.layerInfo[g].iconUrl.length;d++)c+='<img src="'+this.layerInfo[g].iconUrl[d]+'" alt="icon '+d+" for "+this.layerInfo[g].title+'" class="iconBulletPoint" width="'+this.opts.iconWidth+'" height="'+this.opts.iconHeight+'" /> ';c+=""+this.layerInfo[g].title+' <a href="#" onclick="'+a.variableName+".changeLayerVisibility("+
g+'); return false;">'+f+"</a>";this.opts.hiddenLayersRemovedFromList||(c+=' - <a href="#" onclick="'+a.variableName+".deleteLayer("+g+'); return false;">'+a._t.remove+"</a>");this.opts.addKmlLink&&this.layerInfo[g].url&&(c+=' (<a href="'+this.layerInfo[g].url+'&kml=1">'+a._t.kml+"</a>)</li>")}b.innerHTML=c+"<ul>"}else console.debug("you defined the layerlist like this "+this.opts.layerListId+", but it does not exist")}},updateTitles:function(){for(var b=this.opts.defaultTitle,a=this.layerInfo.length-
1;-1<a;a--)this.layerInfo[a].show&&(b=this.layerInfo[a].title,a=-99);this.opts.titleId&&(a=document.getElementById(this.opts.titleId),null!==a&&(a.innerHTML=b));this.opts.changePageTitle&&document.title&&(document.title=b)},updateStatus:function(b,c){var d="",e="";"help"==c&&(b&&(b+="<hr />"),b+="<hr />"+this.helpHtml()+"");document.getElementById(this.mapDivName)&&(this.mapIsZoomed?(e="reduce map size",d=""):(e="full-screen",d='<span>|</span> <a href="#" onclick="'+a.variableName+'.hideStatus();">'+
a._t.hide+"</a> "));d='<p class="helpLink" style="text-align: right; font-size: 10px; width: auto; float: right;">'+(' <a href="#" onclick="'+a.variableName+".updateStatus('', 'help'); return false;\"> "+a._t.show_help+' </a> <span>|</span> <a href="#" onclick="'+a.variableName+'.enlargeMap(); return false;" id="mapZoomLinkLabel">'+e+"</a> "+d+"</p>"+b);this.opts.statusDivId&&(e=document.getElementById(this.opts.statusDivId),null!==e&&(e.innerHTML=d,e.style.display="block"))},hideStatus:function(){if(this.opts.statusDivId){var b=
document.getElementById(this.opts.statusDivId);null===b||this.mapIsZoomed?this.mapIsZoomed&&alert(a._t.can_not_hide_bar_in_full_screen_mode):(b=document.getElementById(this.opts.statusDivId),b.style.display="none")}},showAddress:function(b){var c="";this.opts.defaultCountryCode&&(c=this.opts.defaultCountryCode);a.geocoder=new google.maps.Geocoder;if(a.geocoder)return this.updateStatus(a._t.search_for_address),this.mapAddress=b,a.geocoder.geocode({address:b,region:c},function(b,c){if(c==google.maps.GeocoderStatus.OK){console.debug(b);
var d=b[0];a.addAddressToMap(d);a.mapObject.setCenter(d.geometry.location)}else alert("Geocode was not successful for the following reason: "+c)}),!1;this.updateStatus(a._t.address_finder_not_loaded)},addAddressToMap:function(b){place=b.geometry.location;var c=new google.maps.LatLng(place.lat(),place.lng());b=place.formatted_address;c=a.createPointXml(a._t.address_search+": "+a.mapAddress,c,b);a.processXml(c);a.updateStatus(a._t.address_found+": "+b);b=a.opts.updateServerUrlAddressSearchPoint+encodeURIComponent(b)+
"/"+place.lng()+"/"+place.lat()+"/";a.addLayer(b);return!0},updateAddressFormFields:function(b){a.opts.latFormFieldId&&null!==document.getElementById(a.opts.latFormFieldId)&&(document.getElementById(a.opts.latFormFieldId).value=b.lat(),document.getElementById(a.opts.lngFormFieldId).value=b.lng())},showRoute:function(){this.floatFrom?this.floatTo?(a.routeShown=!0,this.updateStatus(a._t.searching_for_route),a.directions.load(this.floatFrom+" to "+this.floatTo,{locale:this.opts.localeForResults,getSteps:!0})):
this.updateStatus(a._t.no_valid_end):this.updateStatus(a._t.no_valid_start)},createRouteFromLayer:function(b){var c=[],d=0,e=!1;2>this.layerInfo[b].pointCount&&(e=!0);for(var f=0;f<this.gmarkers.length;f++)if(this.gmarkers[f].layerId==b||!0===e)c[d]=d+1+": "+this.gmarkers[f].markerName+"@"+this.gmarkers[f].getPosition().lat()+","+this.gmarkers[f].getPosition().lng(),d++;c.length?(a.routeShown=!0,this.updateStatus(a._t.searching_for_route),a.directions.route({origin:a.floatFrom,destination:a.floatTo,
travelMode:google.maps.TravelMode.TRANSIT},function(b,c){c==google.maps.DirectionsStatus.OK&&a.directionsDisplay.setDirections(b)})):this.updateStatus(a._t.no_route_could_be_found)},currentFromLocation:function(){var b="";this.from?b='<span id="currentlySetToFrom">'+this.currentlySetToString+this.from+"</span>":this.floatFrom&&(b='<span id="currentlySetToTo">'+this.currentlySetToString+this.floatFrom+"</span>");return b},currentToLocation:function(){var b="";this.to?b=this.currentlySetToString+this.to:
this.floatTo&&(b=this.currentlySetToString+this.floatTo);return b},clearRouteVariables:function(){this.to="";this.floatTo=0;this.from="";this.floatFrom=0;var b=document.getElementById("currentlySetToFrom");null!==b&&(b.innerHTML="");b=document.getElementById("currentlySetToTo");null!==b&&(b.innerHTML="")},clearRouteAll:function(){var b=document.getElementById(a.opts.directionsDivId);null!==b&&(b.innerHTML="");this.clearRouteVariables();this.routeShown=!1;a.directions.clear();a.updateStatus("Route Cleared")},
directionsHandleErrors:function(){a.directions.getStatus().code==G_GEO_UNKNOWN_ADDRESS?a.updateStatus("No corresponding geographic location could be found for one of the specified addresses. This may be due to the fact that the address is relatively new, or it may be incorrect.\nError code: "+a.directions.getStatus().code):a.directions.getStatus().code==G_GEO_SERVER_ERROR?a.updateStatus("A geocoding or directions request could not be successfully processed, yet the exact reason for the failure is not known.\n Error code: "+
...
null,h=null,k="",l="",m=0;m<a.directions.getNumRoutes();m++)for(0===m?(k="play",l=a.from):(k="pause",l=a.via),h=a.directions.getRoute(m),f=h.getStartGeocode(),g=h.getStep(0).getLatLng(),b(g,k,f.address,l),e+='<tr><th colspan="2" class="routeDistance">'+(d(h.getDistance().meters)+" - about "+h.getDuration().html)+"</th></tr>",f=0;f<h.getNumSteps();f++)g=h.getStep(f),c(g.getLatLng(),f+1,g.getDescriptionHtml(),d(g.getDistance().meters));f=h.getEndGeocode();g=h.getEndLatLng();l=a.to;b(g,"stop",f.address,
l);e+='<tr><th colspan="2" class="copyright">'+a.directions.getCopyrightsHtml()+"</th></tr>";e='<div id="directionsInnerDiv"> <table class="directionsClassTable"><col class="col1" /><col class="col2"/>'+e+"</table></div>";(h=document.getElementById(a.opts.directionsDivId))?(e+='<p id="directionsPrintOptions"><a href="#" onclick="'+a.variableName+'.printDirections(); return false;">Print Directions</a>, <a href="#" onclick="'+a.variableName+'.clearRouteAll(); return false;">Clear Route</a></p>',h.innerHTML=
...
a.opts.statusDivId?(b=document.getElementById(a.opts.statusDivId),null!==b?b.innerHTML=a._t.loading_map:a.opts.statusDivId="statusDivOnMap"):a.opts.statusDivId="statusDivOnMap";a.opts.directionsDivId&&(b=document.getElementById(a.opts.directionsDivId),null!==b?b.innerHTML="":a.opts.directionsDivId="");a.clearRouteVariables();a.mapAddress="";a.currentlySetToString="<br />"+a._t.currently_set_to;a.map||a.setupMap(h);b=new google.maps.LatLng(a.opts.defaultLatitude,a.opts.defaultLongitude,!1);a.zoomTo(b,
a.opts.defaultZoom);a.mapObject.clearOverlays(a.markersArray);a.opts.mapTypeDefault&&(b=a.mapTypesArray(a.opts.mapTypeDefault-0),a.mapObject.setMapTypeId(b));a.defaultUrl&&a.downloadXml(a.defaultUrl);a.mapOriginalSize={width:a.mapObject.getDiv().offsetWidth,height:a.mapObject.getDiv().offsetHeight};a.updateStatus(a._t.map_ready)}}}Array.prototype.inArray=function(h){for(var l=0;l<this.length;l++)if(this[l]===h)return l+1;return!1};
Array.prototype.inSubArray=function(h,l){for(var q=[],m=0;m<this.length;m++)q.push(this[m][h]);return q.inArray(l)};function mapFunctionIsDefined(h){return"undefined"==typeof window[h]?!1:!0}"undefined"!==typeof google&&(google.maps.Map.prototype.clearOverlays=function(h){for(var l=0;l<h.length;l++)h[l].setMap(null)});
function createXmlHttpRequest(){try{if("undefined"!=typeof ActiveXObject)return new ActiveXObject("Microsoft.XMLHTTP");if(window.XMLHttpRequest)return new XMLHttpRequest}catch(h){changeStatus(h)}return null}function downloadUrl(h,l){var q=-1,m=createXmlHttpRequest();if(!m)return!1;m.onreadystatechange=function(){if(4==m.readyState){try{q=m.status}catch(a){}200==q&&(l(xmlParse(m.response),m.status),m.onreadystatechange=function(){})}};m.open("GET",h,!0);try{m.send(null)}catch(a){changeStatus(a)}}
function xmlParse(h){if("undefined"!=typeof ActiveXObject&&"undefined"!=typeof GetObject){var l=new ActiveXObject("Microsoft.XMLDOM");l.loadXML(h);return l}return"undefined"!=typeof DOMParser?(new DOMParser).parseFromString(h,"text/xml"):createElement("div",null)};
